...
sectioning and detail.

## Submission Routes

Treat each target-journal attempt, transfer, technical return, and revision as
a distinct route with its own current requirement record, declarations,
package state, portal record, and accountable approval.

Use assets/submission-route.template.md. Final journal requirements must be
retrieved from an authoritative current source before package release.
