...
v0.4.0 release records are retained. The local v0.5.0 provenance-register-set
candidate is not an installation target; normal installation eligibility is
...
`PUBLIC_MATERIAL_RIGHTS_REVIEW_v0.5.0.md`, `V0_5_CAPABILITY_ADMISSION.md`,
and `RELEASE_NOTES_v0.5.0.md` are active pre-C3 candidate materials. They
describe a proposed metadata-only provenance register set and preserve the
separate exact-commit, capability-admission, C4, and post-release boundaries.
They do not make a v0.5.0 public availability or installation claim.
