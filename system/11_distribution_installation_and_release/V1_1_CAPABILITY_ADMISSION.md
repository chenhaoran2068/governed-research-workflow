...
Status: the accountable human admitted `GRW-CAP-111-01` for the proposed
v1.1.0 release scope on `2026-07-26`, after local implementation, candidate
content review, and release preparation. This is not C4, an exact commit, a
tag, GitHub Release, or installed-runtime statement.
...
- Two local full-regression runs passed 272 tests with 3 existing skips and no
