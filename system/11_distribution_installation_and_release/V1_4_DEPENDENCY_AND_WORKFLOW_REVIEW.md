# V1.4.0 Dependency And Workflow Review
...
- The validator reuses jsonschema==4.26.0.
- It uses only existing Python standard-library JSON, path, hash, and argument
  parsing support in addition to the existing schema validator.
...
- New tests use wholly synthetic JSON and temporary test-owned files. They do
  not contact a service or resolve a source body, pointer, locator, path, or
  inventory.
