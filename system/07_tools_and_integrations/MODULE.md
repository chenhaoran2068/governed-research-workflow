...
Status: v0.8 candidate source retains one controlled bootstrap helper and adds
only its candidate helper-admission record. Framework integration is test-only
