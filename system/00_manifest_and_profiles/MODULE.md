...
Status: v0.9.0 integrity-audit source manifest; exact released-framework
...
current v0.9.0 integrity-audit source retains exactly those two public identifiers
and does not add a private profile, service discovery, or a private-path fallback.
