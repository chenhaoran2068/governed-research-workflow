...
Status: v0.8 pre-C4 public release-source manifest; exact released-framework
...
current v0.8 pre-C4 release source retains exactly those two public identifiers and
...
final exact-commit evidence and C4 remain separate. The v0.8 ledger adds three
verified, release-scope-admitted records; that admission does not change the
