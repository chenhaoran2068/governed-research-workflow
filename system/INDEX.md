...
Status: v1.9.1 public new-Study navigation stop-boundary maintenance source
retaining the
...
It retains `GRW-CAP-190-01`: generic natural-language new-Study navigation and
a human-confirmable route recommendation that precedes methods, lifecycle
guidance, external sources, and project creation.
...
| --- | --- | --- | --- |
| `00` | manifest and profiles | v1.9.1 retains the two public profiles, declares only exact Framework v0.2.0 compatibility, and hardens generic new-Study navigation | root `SYSTEM_MANIFEST.yaml`, module records |
