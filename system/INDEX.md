...
Status: v1.16.0 manuscript-style-profile source retaining the
...
structural schema, and an explicit one-record read-only validator. It declares only the exact Workspace Framework `v0.4.0`
...
| `09` | schemas, records, and templates | blank-record baseline plus v0.8/v0.9 controls, v0.10 experience package, v0.10.1 synthetic exchange receipt schema, v0.11 Markdown templates, v1.15 joint-review-plan, and v1.16 manuscript-style-profile schema/templates | `assets/` templates and schemas |
