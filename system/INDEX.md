...
Status: v1.6.0 public-safe shared-experience derivative source retaining the
frozen public-interface contract and `GRW-CAP-150-01` guidance introduced by
v1.5.0. It adds `GRW-CAP-160-01` only as public vocabulary, catalogue, and
selectively read generic guidance cards. It declares only the exact Workspace
Framework `v0.2.0` contract and preserves the V1 Public Interface Manifest,
Capability Verification Map, and V1 Support Scope Matrix. It adds no intake,
exchange, data, retrieval, execution, sharing, submission, automatic loading,
...
| --- | --- | --- | --- |
| `00` | manifest and profiles | v1.6.0 retains the two public profiles, declares only exact Framework v0.2.0 compatibility, and adds public-safe shared-experience derivative routing | root `SYSTEM_MANIFEST.yaml`, module records |
