...
The historical v0.8.0 pre-C4 source record adds structural role-contract and
helper-admission tests, profile-boundary tests, and synthetic cross-control assurance. They
...
The local-only v0.9 candidate adds a finite metadata-only integrity-audit
bundle, a read-only structural validator, and a synthetic candidate evidence
