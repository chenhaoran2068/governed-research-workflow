...
`tests/test_v0_4_synthetic_assurance.py` combines the unreleased candidate records,
current/historical release boundary, synthetic templates, profile identity, and
refusal paths. Its run record is candidate-only evidence, not an installed
