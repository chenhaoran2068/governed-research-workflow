...
`tests/` protects the controlled bootstrap helper and the candidate module
inventory. Passing tests prove only the tested technical behavior. They do not
approve scientific quality, compliance, data access, manuscript claims, or a
submission package.
