...
| `GRW-CAP-190-01` | C2-admitted v1.9.1 maintenance source scope | Generic navigator route, first-response stop boundary, human-confirmation boundary, and synthetic route/refusal tests | Does not create a Study, determine a design or governance fact, access material, execute research, or grant approval, Release, or installation authority. |
