...
class V09ReleasePreparationTests(unittest.TestCase):
    def test_v09_history_is_retained_while_current_source_moves_forward(self) -> None:
        ...
        self.assertIn("Status: v0.10.1 self-controlled synthetic experience-exchange pilot source", readme)
        self.assertIn("## v0.9.0 (integrity-audit source)", roadmap)
        self.assertIn("Status: v0.10.1 self-controlled synthetic experience-exchange pilot source", index)
