...
class ReleaseControlTests(unittest.TestCase):
    def test_required_release_and_maintenance_records_exist(self) -> None:
        required_records = (
            ...
            "PUBLIC_MATERIAL_RIGHTS_REVIEW_v1.13.0.md",
            "V1_13_DEPENDENCY_AND_WORKFLOW_REVIEW.md",
            "V1_13_RELEASE_GATE.md",
            ...
            "V1_18_DEPENDENCY_AND_WORKFLOW_REVIEW.md",
            "V1_18_RELEASE_GATE.md",
            "V1_18_RELEASE_CONTROL_CANDIDATE.json",
            "V1_18_RELEASE_EVIDENCE.md",
