"""Regression checks for release-control and release-gated source records."""
...
class ReleaseControlTests(unittest.TestCase):
    ...
    def test_release_gated_source_names_its_own_exact_framework_target(self) -> None:
        ...
        self.assertIn("release-gated source version `0.3.1`", readme)
        self.assertIn("v0.3.1 (release-gated compatibility-maintenance source)", roadmap)
    ...
    def test_current_records_distinguish_releases_gated_sources_and_historical_snapshots(self) -> None:
        ...
        self.assertIn("exact Workspace Framework v0.1.1", integrity)
        self.assertIn("Status: release-gated public source on `main`.", candidate)
