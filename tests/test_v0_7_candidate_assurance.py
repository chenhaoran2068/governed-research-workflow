"""Release-source assurance for v0.7 lesson-promotion controls."""
...
class V07ReleaseSourceAssuranceTests(unittest.TestCase):
    def test_release_scope_admission_is_distinct_from_selected_version_status(self) -> None:
        ...
        self.assertIn("historical pre-c4", ADMISSION_PATH.read_text(encoding="utf-8").lower())

    def test_release_source_interface_is_complete_and_has_no_private_path_claim(self) -> None:
        expected = (
    ...
    def test_release_source_materials_keep_historical_c4_and_runtime_boundaries(self) -> None:
        ...
        self.assertIn("historical pre-c4", combined)
